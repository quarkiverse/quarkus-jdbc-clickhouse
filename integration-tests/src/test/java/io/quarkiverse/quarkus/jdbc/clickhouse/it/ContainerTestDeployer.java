...
public class ContainerTestDeployer implements QuarkusTestResourceLifecycleManager, DevServicesContext.ContextAware {
    ...
    public Map<String, String> start() {
        container = new ClickHouseContainer(CLICKHOUSE_CLICKHOUSE_SERVER)
    ...
    //        String hostPort = container.getHost() + ':' + container.getMappedPort(org.testcontainers.clickhouse.ClickHouseContainer.HTTP_PORT);
    //
